...
subtitle.Text = "Tween • Interact • Anti AFK"
...
info.Text = "4 WAYPOINTS  •  LOOP FOREVER"
...
local function tweenTo(position)
	...
	local time = tonumber(speedBox.Text) or 2
			...
			for _,obj in ipairs(
				...
				and obj.Enabled then
					...
					and parent:IsA("BasePart") then
						...
						local distance =
							(hrp.Position - parent.Position).Magnitude
